export const booksData = [
  ...
  },
  {
    ...
    price: 29.99,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@angular_up_and_running.jpg",
  ...
  },
  {
    ...
    price: 12.99,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@restful_web_apis.jpg",
  ...
  },
  {
    ...
    price: 6.99,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@universal_design_for_web_applications.jpg",
  ...
  },
  {
    ...
    price: 10.89,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@websocket.jpg",
    title: "WebSocket",
    shortDescription:
      "Until recently, creating desktop-like applications in the browser meant using inefficient Ajax or Comet technologies to communicate with the server.",
    description:
  ...
  },
  {
    ...
    price: 14.49,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@securing_ajax_applications.jpg",
  ...
  },
  {
    ...
    price: 26.49,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@version_control_with_git_3rd_edition.jpg",
  ...
  },
  {
    ...
    price: 29.49,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@mongodb_the_definitive_guide_3rd_edition.jpg",
    title: "MongoDB: The Definitive Guide, 3rd Edition",
    shortDescription:
      "Manage your data with a system designed to support modern application development.",
    description:
  ...
  },
  {
    ...
    price: 6.39,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@learning_git.jpg",
    title: "Learning Git",
    shortDescription:
      "Learn the basics of Git in a simple, visual, and tangible manner.",
    description:
  ...
  },
  {
    ...
    price: 21.49,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@using_svg_with_css3_and_html5.jpg",
    title: "Using SVG with CSS3 and HTML5",
    shortDescription:
      "Using Scalable Vector Graphics (SVG) for illustrations only scratches the surface of this format’s potential on the web.",
    description:
  ...
  },
  {
    ...
    price: 28.39,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@svg_animations.jpg",
    title: "SVG Animations",
    shortDescription:
      "SVG is extremely powerful, with its reduced HTTP requests and crispness on any display.",
    description:
  ...
  },
  {
    ...
    price: 7.39,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@git_for_teams.jpg",
    title: "Git for Teams",
  ...
  },
  {
    ...
    price: 38.49,
    image:
      "https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@learning_node_2nd_edition.jpg",
